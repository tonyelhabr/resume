...
+ [Demand/supply curves are convex (and not linear) due to:](https://www.quora.com/Why-are-demand-curves-downward-sloping)
  1. Substitution effect: "Suppose that the price of the good falls from $p_0$ to $p_1$ then the consumer will substitute other goods to buy this good."
...
# Electricity Trading Questionnaire
